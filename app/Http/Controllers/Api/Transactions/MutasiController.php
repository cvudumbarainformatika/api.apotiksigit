...
class MutasiController extends Controller
{
    public function getCabang()
    {
        ...
        $data = Cabang::select('kodecabang', 'namacabang', 'url', 'identitas')
    ...
    public function index()
    {
        ...
        $raw->when(request('q'), function ($q) {
            ...
            ->when(request('dari') != null, function ($q) {
                $q->whereIn('dari', request('dari'));
            })
            ->when(request('tujuan') != null, function ($q) {
                $q->whereIn('tujuan', request('tujuan'));
            })
            ->with([
    ...
    public function simpan(Request $request)
    {
        ...
        try {
            ...
            $databyid = MutasiHeader::find($id);
            $databykdmutasi = MutasiHeader::where('kode_mutasi', $kode_mutasi)->first();
            $data = $databyid ?? $databykdmutasi;
            if ($data) {
                $data->update([
